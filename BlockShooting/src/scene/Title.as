package scene
{
	...
	public class Title extends DisplayObjectContainer implements IFScene
	{
		/** タイトル文字列 */
		private static const TITLE_STRING:String = "Block Shooting";
		/** タイトルサブ文字列 */
		private static const SUB_TITLE_STRING:String = "Tap to start...";

		public function Title(data:Object = null)
		{
			super();
